...
function showResult() {
    ...
    if (userScore > 3) {
        let scoreTag = '<p>🥳 Wooow you are genuis, you answered ' + userScore + ' questions correctly!</p>'
        scoreText.innerHTML = scoreTag;
    } else if(userScore > 1) {
        let scoreTag = '<p>😉 Good Job! you unswered ' + userScore + ' questions correctly!</p>'
        scoreText.innerHTML = scoreTag;
    } else {
        let scoreTag = '<p>😐 Unfortunately your score is low. Please try again:)</p>'
        scoreText.innerHTML = scoreTag;
    }
}
